...
namespace Fusion
{
	...
	public:
        ...
        void AddPolyLine(const FVec2* points, int numPoints, u32 color, f32 thickness, bool closed, bool antiAliased, u32 drawItemIndex = 0, const f32* uvXValues = nullptr, const FRect* minMaxPos = nullptr);
